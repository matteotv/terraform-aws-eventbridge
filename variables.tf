...
variable "create_rules_lifecycle" {
  description = "Controls whether EventBridge Rule with lifecycle resources should be created"
  type        = bool
  default     = true
}
...
variable "create_schedules_lifecycle" {
  description = "Controls whether EventBridge Schedule with lifecycle resources should be created"
  type        = bool
  default     = true
}
